...
## 개요
도미노 현상을 모티브로 삼아 개발한 **2D 쿼터뷰 어드벤쳐 게임**
...
△ 선내에서 다른 도미니언과 대화하거나 각종 기물들과 상호작용할 수 있다.
...
도미노가 많이 모여 있을수록 하나가 넘어졌을 때의 여파는 커진다. 도미노의 이런 특징을 활용하여 수도권과 같은 **초고밀도 사회**에서 수많은 사람들 사이에 둘러싸여 있을 때 커지는 **스트레스와 예민함**을 표현하고자 했다. 플레이어는 도미노 캐릭터들 간의 연쇄 충돌을 차단하거나 유도하면서 아기자기한 그래픽과 대비되는 아슬아슬한 긴장감을 느낄 수 있을 것이다.     
